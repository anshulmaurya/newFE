          ...
          <div className="flex-1 space-y-4 w-full">
            ...
            <div className="bg-[rgb(18,18,20)] rounded-lg border border-[rgb(45,45,50)] p-6 mt-4">
              <div className="flex items-center mb-3">
                <SiApple className="text-3xl text-white mr-3" />
                <h1 className="text-2xl font-bold text-[rgb(214,251,65)]">Apple Interview Preparation</h1>
              </div>
              <p className="text-gray-300 mb-4">
                A targeted preparation bundle specifically designed for Apple embedded systems interviews. 
                This bundle focuses on the types of problems and concepts commonly asked in Apple interviews.
              </p>
              
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center">
                  <Clock className="h-4 w-4 text-blue-400 mr-2" />
                  <span className="text-gray-300">Most Frequent Questions</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="h-4 w-4 text-green-400 mr-2" />
                  <span className="text-gray-300">Company-Specific Focus</span>
                </div>
                <div className="flex items-center">
                  <Zap className="h-4 w-4 text-yellow-400 mr-2" />
                  <span className="text-gray-300">Updated Interview Patterns</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[rgb(18,18,20)] rounded-lg border border-[rgb(45,45,50)] p-6">
              <h2 className="text-xl font-bold mb-4">Apple Interview Problems</h2>
              ...
              {isLoadingExternal ? (
                ...
                <div className="space-y-3">
                  {externalProblems
                    ...
                    // For a real implementation, we would filter by Apple-specific problems
                    // For now, we'll just display a selection of problems
                    .slice(1, 7) // Get a different subset of problems for this bundle
