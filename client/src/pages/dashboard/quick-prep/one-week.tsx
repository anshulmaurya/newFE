        ...
        <div className="flex">
          <div className="flex-1 space-y-4 w-full">
            ...
            <div className="bg-[rgb(18,18,20)] rounded-lg border border-[rgb(45,45,50)] p-6 mt-4">
              <h1 className="text-2xl font-bold text-[rgb(214,251,65)] mb-2">1 Week Preparation Bundle</h1>
              <p className="text-gray-300 mb-4">
                A rapid-fire preparation plan for embedded systems interviews, covering only the most essential concepts 
                and frequently asked questions. Designed for last-minute preparation or quick refreshers.
              </p>
              
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center">
                  <Clock className="h-4 w-4 text-blue-400 mr-2" />
                  <span className="text-gray-300">Duration: 7 days</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="h-4 w-4 text-green-400 mr-2" />
                  <span className="text-gray-300">20+ Practice Problems</span>
                </div>
                <div className="flex items-center">
                  <Zap className="h-4 w-4 text-yellow-400 mr-2" />
                  <span className="text-gray-300">Essential Coverage</span>
                </div>
              </div>
            </div>
              ...
              {isLoadingExternal ? (
                ...
                <div className="space-y-3">
                  {externalProblems
                    ...
                    .slice(0, 5) // Limit to first 5 problems for this bundle
