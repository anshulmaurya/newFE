  ...
  return (
    <div className="bg-[rgb(14,14,16)] text-white h-screen overflow-hidden">
      ...
      <div className="flex h-[calc(100vh-64px)] overflow-hidden">
        ...
        <div className="w-full lg:ml-56 lg:mr-64 overflow-y-auto overflow-x-hidden px-4 lg:px-0 pt-0 pb-0">
          {/* Main content area */}
          <div className="flex-grow pt-0 pb-4 px-2 space-y-2 overflow-x-hidden">
